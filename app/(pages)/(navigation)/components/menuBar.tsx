...
const MenuBar = () => {
  ...
  return (
    ...
    !menuOpen ?
      <div className='min-h-screen bg-lightBlue w-16 md:w-32 rounded-2xl flex flex-col items-center py-8  relative' >
        ...
        <div className='bottom-0 my-5 absolute hover:border hover:border-white p-3 rounded-xl hover:scale-110 cursor pointer'>
          <AiOutlinePoweroff size={30} className='text-white' />
        </div>
      </div>
      :
      <div className='min-h-screen bg-white w-[300px] md:w-1/5 rounded-2xl flex flex-col items-center py-8 relative' >
