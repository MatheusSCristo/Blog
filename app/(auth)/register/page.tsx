...
const handleOnClickSubmit = (data: any) => {
}
...
return (
    <main className='m-10 flex justify-center items-center min-h-[100vh] m-0 relative '>
        <Image src={'/bgRegister.jpg'} fill={true} objectFit='' alt='bg-IMG' />
        ...
        <div className='flex flex-col p-5 items-center bg-white z-10 md:w-2/5 rounded-2xl gap-2'>
            ...
            <form className='flex flex-col md:w-3/5 text-lightGray ' onSubmit={handleSubmit(handleOnClickSubmit)}>
                ...
                <button type='submit' className='bg-lightBlue w-1/2  rounded-2xl text-white uppercase m-auto my-5 p-3 font-semibold'>Criar conta</button>
            </form>
